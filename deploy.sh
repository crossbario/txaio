...
echo ''
echo '      https://crossbarbuilder.s3.eu-central-1.amazonaws.com/wheels/txaio-'${TXAIO_VERSION}'-py2.py3-none-any.whl'
echo '      https://crossbarbuilder.s3.eu-central-1.amazonaws.com/wheels/txaio-latest-py2.py3-none-any.whl'
echo ''
